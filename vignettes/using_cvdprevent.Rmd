...
To get details for areas as a tibble including children areas (and sub-children up to 3 levels deep) you can use the function `cvd_area_nested_subsystems()` function. An area ID is a required parameter. Here we return details for Somerset STP:
...
Priority groups are collections of *Indicators* which are displayed in the [Regional & ICS insights](https://data.cvdprevent.nhs.uk/insights) page of the CVD PREVENT website.

Here we return the indicators in the Chronic Kidney Disease (CKD) priority group:
