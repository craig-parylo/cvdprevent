...
To working with indicators, you first need to identify both tthe **time period** and the **system level** of interest. This is important because not all indicators are available at every system level. For example, some indicators are not reported for PCN or Practice levels.

The following example dmonstrates how to list indicators available for each system level in *time period 26*.
...
The example below shows how to list all metrics available fro the indicator **AF: Prevalence (CVDP01AF)** (Indicator ID = 1) in *time period 26* at the *England* system level:
